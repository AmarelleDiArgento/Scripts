...
__conda_setup="$('/home/freya/anaconda/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/freya/anaconda/etc/profile.d/conda.sh" ]; then
        . "/home/freya/anaconda/etc/profile.d/conda.sh"
    else
        export PATH="/home/freya/anaconda/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<#
